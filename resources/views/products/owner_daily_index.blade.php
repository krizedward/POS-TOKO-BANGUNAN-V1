					...
					<div class="widget-box widget-color-blue">
						<div class="widget-header">
							<h5 class="widget-title bigger lighter">
                                ...
                                @php $date = $startDate; @endphp
								Laporan Harian Pada Bulan {{ date('M', strtotime($date)) }}
							</h5>
								...
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>0</td>
                                            <td class="hidden-480">
												<a href="{{ route('barang.owner.daily.show',[$date]) }}" class="label label-warning">Details</a>
										    </td>
                                        </tr>
                                        @endwhile
									</tbody>
