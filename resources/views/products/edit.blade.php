...
<div class="page-header">
	<h1>
		...
		<small>
			...
			Halaman yang berisikan form untuk mengubah data barang yang ada digudang.
		</small>
	</h1>
</div><!-- /.page-header -->
@endsection
...
<div class="row">
	<div class="col-xs-12">
        ...
        @endif
		<form class="form-horizontal" action="{{ route('products.update', $data->id) }}" method="post" enctype="multipart/form-data">
			@csrf
			@method('PUT')
            <!-- kode -->
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="name_product" value="{{ $data->name_product }}" id="form-field-1" placeholder="nama barang.." class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<!-- copy -->
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-xs-10 col-sm-4">
					<select class="chosen-select" id="form-field-select-3" data-placeholder="{{ $data->detail_categories->name }}" name="detail_categories_id">
