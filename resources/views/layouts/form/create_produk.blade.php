...
<script>
  $(document).ready(function() {
    $('#myButton').click(function() {
      // Panggil Controller 1
      $.ajax({
        url: `{{ route('produk.gambar.store') }}`,
        method: 'POST',
        success: function(response) {
          console.log('Controller 1 berhasil dipanggil.');
          // Tangani respons Controller 1
        },
        error: function(xhr) {
          console.log('Terjadi kesalahan saat memanggil Controller 1.');
          // Tangani kesalahan Controller 1
        }
      });
    });
  });
