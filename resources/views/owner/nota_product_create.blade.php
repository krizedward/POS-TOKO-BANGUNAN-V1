	...
	<div class="page-header">
		<h1>
			...
			<small>
				...
				Halaman yang berisikan form tambah nota gudang.
			</small>
		</h1>
	</div><!-- /.page-header -->
@endsection
...
@section('main')
	<div class="row">
		<div class="col-xs-12">
			...
			@endif
			<form class="form-horizontal" action="{{ route('owner.product.store','nota') }}" method="post" enctype="multipart/form-data">
				@csrf
				@method('POST')
				...
				<!-- nomor DO -->
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nomor DO </label>
					<div class="col-sm-9">
						<input type="text" name="Nomor DO" id="form-field-1" placeholder="Nomor DO.." class="col-xs-10 col-sm-5" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="quantity" id="form-field-1" placeholder="jumlah" class="col-xs-10 col-sm-5" />
					</div>
				</div>

				<!-- form tanggal kirim -->
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> tanggal kirim </label>
					<div class="col-sm-9">
						<input type="text" name="date_send" id="form-field-1" placeholder="tanggal kirim" class="col-xs-10 col-sm-5" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="description" id="form-field-1" placeholder="deskripsi" class="col-xs-10 col-sm-5" />
					</div>
				</div>
