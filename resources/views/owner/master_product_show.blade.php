...
@section('main')
<<<<<<< HEAD
	<!-- untuk membuat tabel yang baik -->
    @include('layouts.table.master_product_show')
=======
    <!-- PAGE CONTENT BEGINS -->
    							<div class="clearfix">
									<div class="pull-left alert alert-success no-margin alert-dismissable">
										...
										<i class="ace-icon fa fa-book bigger-120 blue"></i>
										Klik <a href="#">disini</a> untuk mendapatkan panduan jika mengerti bisa klik silang...
									</div>

									<div class="pull-right">
										<span class="green middle bolder">Halaman : &nbsp;</span>
								...
								@include('layouts.detail.master_product_show')
