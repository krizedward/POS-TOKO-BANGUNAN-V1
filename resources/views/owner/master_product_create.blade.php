...
@section('breadcrumbs')
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li>
				<a href="{{ route('owner.product.index','master') }}">Barang</a>
			</li>
...
@section('main')
	<div class="row">
		<div class="col-xs-12">
			...
			@endif
			<!-- form -->
			@include('layouts.form.master_product_create')
			<!-- PAGE CONTENT ENDS -->
		</div><!-- /.col -->
	</div><!-- /.row -->
@endsection
...
@section('main-old')
	<div class="row">
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
			<form class="form-horizontal" action="{{ route('owner.product.store','master') }}" method="post" role="form">
				@csrf
				@method('POST')
				<!-- kode -->
